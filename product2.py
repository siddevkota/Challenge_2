...
def app():
    ...
    st.image("product2.png", caption="Product Image", width=300)
    ...
    LMN Smartphone \n 
    Description: \n
    The LMN Smartphone boasts a sleek design and cutting-edge features.
''')
    
    sensitive_keywords = ["sexist", "misogyny", "health hazard", "offensive"]
    # Create an input field for user input
    product_description = '''
    Product: LMN Smartphone <br> Description: The LMN Smartphone boasts a sleek design and cutting-edge features.
'''
