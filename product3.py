...
def app():
    ...
    st.image("product3.png", caption="Product Image", width=300)

    st.write('''
    Product:\n 
    XYZ Sports Drink \n 
    Description:\n
    The XYZ Sports Drink is a refreshing and hydrating beverage for active individuals, designed to keep you energized during your workouts.
''')
    ...
    product_description = '''
    Product: XYZ Sports drink Description: The XYZ Sports Drink is a refreshing and hydrating beverage for active individuals, designed to keep you energized during your workouts..
'''
